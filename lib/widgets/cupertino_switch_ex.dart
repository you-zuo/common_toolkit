...
///
/// {@tool dartpad}
/// This example shows a toggleable [CupertinoSwitchEx]. When the thumb slides to
...
/// {@tool snippet}
///
/// This sample shows how to use a [CupertinoSwitchEx] in a [ListTile]. The
...
class CupertinoSwitchEx extends StatefulWidget {
  ...
  /// {@template flutter.cupertino.CupertinoSwitchEx.applyTheme}
  ...
  /// {@template flutter.cupertino.CupertinoSwitchEx.dragStartBehavior}
  ...
  @override
  State<CupertinoSwitchEx> createState() => _CupertinoSwitchState();
...
class _CupertinoSwitchState extends State<CupertinoSwitchEx> with TickerProviderStateMixin {
  ...
  @override
  void didUpdateWidget(CupertinoSwitchEx oldWidget) {
...
const double _kTrackHeight = 21.0;
...
class _RenderCupertinoSwitch extends RenderConstrainedBox {
  ...
  void paint(PaintingContext context, Offset offset) {
    ...
    final double thumbLeft = lerpDouble(
      trackRect.left + _kTrackInnerStart - 9,
      trackRect.left + _kTrackInnerEnd - 9 - currentThumbExtension,
      visualPosition,
    )!;
    final double thumbRight = lerpDouble(
      trackRect.left + _kTrackInnerStart + 9 + currentThumbExtension,
      trackRect.left + _kTrackInnerEnd + 9,
      visualPosition,
    )!;
