...
import 'package:common_toolkit/common_toolkit.dart';
...
class _ChatListViewState extends State<CustomChatListView> {
  ...
  Widget build(BuildContext context) {
    return CustomScrollView(
      ...
      // shrinkWrap: false,
      slivers: <Widget>[
        context.mediaQuery.padding.top.heightBoxSliver,
        ...
        (context.mediaQuery.padding.bottom + kBottomNavigationBarHeight).heightBoxSliver,
      ],
    );
  }
}
